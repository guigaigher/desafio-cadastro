...
public class ExibicaoPet {
    public void exibirPet(Pet pet, int numeroListagem) {
        ArmazenamentoPet ap = new ArmazenamentoPet();
        ...
        System.out.println(numeroListagem + ". " + pet.getNomeCompleto() + " - " + Character.toUpperCase(tipo.charAt(0)) + tipo.substring(1) + " - " +
                ...
                pet.getEndereco().getNumeroCasa() + " - " + pet.getEndereco().getCidade() + " - " + ap.formatarNumero(pet.getIdadeAproximada(), "anos")
                + " - " + ap.formatarNumero(pet.getPesoAproximado(), "kg") + " - " + pet.getRaca());
    }
}
